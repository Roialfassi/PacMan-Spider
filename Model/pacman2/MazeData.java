...
public final class MazeData {
  ...
  public static final int GRID_SIZE_Y = 37;
  public static final int GRID_STROKE = 2;
  public static final int question_Dot = 4;
  public static final int silver_Dot = 5;
  public static final int poison_Dot = 6;
  ...
  /**
   * Private constructor to prevent instantiation.ב�?יזה ציר �?נחנו נעי�?
   */
  private MazeData() { };
...
//הגדרת הנקודות ובדיקת סוג�? ע�? �?נת �?ספור �?ת ס�? הנקודות
  public static void setData(int x, int y, int value) {
    MAZE_DATA[x][y] = value;

    if ((value == question_Dot) || (value == NORMAL_DOT)|| (value == silver_Dot)|| (value == poison_Dot)) {
      dotTotal++;
    }
  } // end setData
