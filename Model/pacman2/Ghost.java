...
import Controller.pacman2.Maze;
 ...
 * @author James "Ghost" ST. Patrick
 * @author Tommy Eagan
 */
public class Ghost extends MovingObject implements MovingInterface {
...
//    url: "{__DIR__}/Resources/pacman/images/ghosthollow2.png"
//  }
  private static final Image HOLLOW_IMAGE1 = new Image(Ghost.class.getResourceAsStream("/Resources/pacman/images/ghosthollow2.png"));

  //  public var HOLLOW_IMAGE2 = Image {
//    url: "{__DIR__}/Resources/pacman/images/ghosthollow3.png"
//  }
  private static final Image HOLLOW_IMAGE2 = new Image(Ghost.class.getResourceAsStream("/Resources/pacman/images/ghosthollow3.png"));

  //  public var HOLLOW_IMAGE3 = Image {
//    url: "{__DIR__}/Resources/pacman/images/ghosthollow1.png"
//  }
  private static final Image HOLLOW_IMAGE3 = new Image(Ghost.class.getResourceAsStream("/Resources/pacman/images/ghosthollow1.png"));
...
//    y = initialLocationY;
    ...
    do {
      potentialx = rand.nextInt(30) + 1;
      potentialy = rand.nextInt(34) + 1;
      if(Maze.DEBUG)
      System.out.println(potentialx+ " , "+potentialy);
    }while(((MazeData.getData(potentialx , potentialy) != 2) && (MazeData.getData(potentialx , potentialy) != 3))
            || ((Math.abs(pacMan.x - potentialx) < 4) || (Math.abs(pacMan.y - potentialy) < 4)));
    x= potentialx;
    y= potentialy;
    if(MazeData.getData(potentialx+1, potentialy) == 2)
    {
      xDirection = 1;
      yDirection=0;
    }
    else{
      if((MazeData.getData(potentialx, potentialy+1) == 2) )
      {
        xDirection = 0;
        yDirection=1;
      }
...
public void setPlace (int x1, int y1)
{
  this.x = x1;
  this.y=y1;
