...
public class GameController implements Initializable
{
	...
	*/
	...
	public void openMain(MouseEvent event) throws Throwable {
		if (game.getGameMode() == 2) game.pauseTimer();
		game.pauseTime();
		if(!game.getOneMaze().gamePaused.getValue())
			game.getOneMaze().pauseGame();
	...
	*/
	...
	public void initialize(URL location, ResourceBundle resources)
    {
		...
		if (game.getGameMode() == 1) timer.setVisible(false);;
		
		maze = game.getOneMaze();
    	userName.setText(game.getUName(1));
    	if (gameController  == null) {
			gameController = new GameController ();
		}
    	updateScore(game.getUScore(1));
    	updateQustion(game.getUQ(1));
    	updateLife(game.getULife(1));
    	gameController.score = score;
    	gameController.life1 = life1;
    	gameController.life2 = life2;
    	gameController.Qbar = Qbar;
    	gameController.question = question;
    	gameController.answer1 = answer1;
    	gameController.answer2 = answer2;
    	gameController.answer3 = answer3;
    	gameController.answer4 = answer4;
	...
	*/
    ...
    /*
	 * starting timer and replace to game2
	*/
	public void replaceGame() {
		Game.startTimer();
    	Windows.swap(Window.Game2);
	}
	/*
	 * Ends the game.
	 * pop alert for confirmation.
