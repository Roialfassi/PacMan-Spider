...
//public class Maze extends CustomNode {
  ...
  public static final boolean DEBUG = true;//To Print things for developers
  public int numOfField=1;//saves the number of the field
  public boolean isquestionon = false;//says if we are during a question right now
  private int nmofquestionchildrenadded =0;// If we added the question ghosts
...
//  public var gamePaused: Boolean = false;
  ...
  private static View.ScoreText[] questionRight = {
//  var scoreText = [
          new View.ScoreText("100", false) //{ level 1
          ,
          new View.ScoreText("200", false) //{ level 2
          ,
          new View.ScoreText("500", false) //level 3
  };

  // text to be displayed for score of eating a ghost
  @SuppressWarnings("unused")
  public View.ScoreText moneyCandy =  new View.ScoreText(String.valueOf(Config.getSilver_dot_value()), false);
...
//    content: [
//      Rectangle {
//        x: Model.pacman.MazeData.calcGridX(5)
//        width: Model.pacman.MazeData.GRID_GAP * 19
//        y: Model.pacman.MazeData.calcGridY(21)
//        height: Model.pacman.MazeData.GRID_GAP *5
//        stroke: Color.RED
//        strokeWidth: 5
//
//        fill: Color.CYAN
...
//      Text {
//        font: Font { size: 18 }
//        x: Model.pacman.MazeData.calcGridX(6)
//        y: Model.pacman.MazeData.calcGridY(24)
//
...
//     font: Font { size: 20
//                 }
//     x: Model.pacman.MazeData.calcGridX(11)
//     y: Model.pacman.MazeData.calcGridY(11)+8
//
...
//        x:0
//        y:0
//        width: Model.pacman.MazeData.calcGridX(Model.pacman.MazeData.GRID_SIZE + 2)
//        height: Model.pacman.MazeData.calcGridY(Model.pacman.MazeData.GRID_SIZE + 3)
//        fill: Color.BLACK
//        cache: true
//      },
//
//      Model.pacman.WallRectangle{ x1:0 y1:0 x2:Model.pacman.MazeData.GRID_SIZE y2:Model.pacman.MazeData.GRID_SIZE },
//
//      Model.pacman.WallRectangle { x1:14 y1:-0.5 x2:15 y2:4 },
//      Model.pacman.WallBlackRectangle { x1:13.8 y1:-1 x2:15.3 y2:0 },
//
//      Model.pacman.WallRectangle { x1:2 y1:2 x2:5 y2:4 },
//      Model.pacman.WallRectangle { x1:7 y1:2 x2:12 y2:4 },
//      Model.pacman.WallRectangle { x1:17 y1:2 x2:22 y2:4 },
//      Model.pacman.WallRectangle { x1:24 y1:2 x2:27 y2:4 },
//      Model.pacman.WallRectangle { x1:2 y1:6 x2:5 y2:7 },
//
//      Model.pacman.WallRectangle { x1:14 y1:6.2 x2:15 y2:10 },
//      Model.pacman.WallRectangle { x1:10 y1:6 x2:19 y2:7 },
//      Model.pacman.WallBlackLine { x1:14 y1:7 x2:15 y2:7 },
//
//      Model.pacman.WallRectangle { x1:7.5 y1:9 x2:12 y2:10 },
//      Model.pacman.WallRectangle { x1:7 y1:6 x2:8 y2:13 },
//      Model.pacman.WallBlackLine { x1:8 y1:9 x2:8 y2:10 },
//
//      Model.pacman.WallRectangle { x1:17 y1:9 x2:21.5 y2:10 },
//      Model.pacman.WallRectangle { x1:21 y1:6 x2:22 y2:13 },
//      Model.pacman.WallBlackLine { x1:21 y1:9 x2:21 y2:10 },
//
//      Model.pacman.WallRectangle { x1:24 y1:6 x2:27 y2:7 },
//
//      Model.pacman.WallRectangle { x1:-1 y1:9 x2:5 y2:13 },
//      Model.pacman.WallRectangle { x1:24 y1:9 x2:Model.pacman.MazeData.GRID_SIZE + 1 y2:13 },
//      Model.pacman.WallBlackLine { x1:0 y1:13 x2:0 y2:15  },
//      Model.pacman.WallBlackLine { x1:Model.pacman.MazeData.GRID_SIZE y1:13 x2:Model.pacman.MazeData.GRID_SIZE y2:15},
//
//      //cage and the gate
//      Model.pacman.WallRectangle { x1:10 y1:12 x2:19 y2:17 },
//      Model.pacman.WallRectangle { x1:10.5 y1:12.5 x2:18.5 y2:16.5 },
//      Rectangle {
//        x: Model.pacman.MazeData.calcGridX(13)
//        width: Model.pacman.MazeData.GRID_GAP * 3
//        y: Model.pacman.MazeData.calcGridY(12)
//        height: Model.pacman.MazeData.GRID_GAP / 2
//        stroke: Color.GREY
//        fill: Color.GREY
//        cache: true
//      },
//
//      Model.pacman.WallRectangle { x1:7.5 y1:19 x2:12 y2:20 },
//      Model.pacman.WallRectangle { x1:7 y1:15 x2:8 y2:23 },
//      Model.pacman.WallBlackLine { x1:8 y1:19 x2:8 y2:20 },
//
//      Model.pacman.WallRectangle { x1:17 y1:19 x2:21.5 y2:20 },
//      Model.pacman.WallRectangle { x1:21 y1:15 x2:22 y2:23 },
//      Model.pacman.WallBlackLine { x1:21 y1:19 x2:21 y2:20 },
//
//      Model.pacman.WallRectangle { x1:14 y1:19 x2:15 y2:27 },
//      Model.pacman.WallRectangle { x1:10 y1:22 x2:19 y2:23 },
//      Model.pacman.WallBlackLine { x1:14 y1:22 x2:15 y2:22 },
//      Model.pacman.WallBlackLine { x1:14 y1:23 x2:15 y2:23 },
//
//      Model.pacman.WallRectangle { x1:2 y1:25 x2:5 y2:27 },
//      Model.pacman.WallRectangle { x1:17 y1:25 x2:22 y2:27 },
//
//      Model.pacman.WallRectangle { x1:7 y1:25 x2:12 y2:27 },
//      Model.pacman.WallRectangle { x1:24 y1:25 x2:27 y2:27 },
//
//      Model.pacman.WallRectangle { x1:-1 y1:15 x2:5 y2:17 },
//      Model.pacman.WallRectangle { x1:4 y1:19 x2:5 y2:23 },
//      Model.pacman.WallRectangle { x1:2 y1:19 x2:4.5 y2:20 },
//      Model.pacman.WallBlackRectangle { x1:4 y1:19.05 x2:5 y2:20.2 },
//      Model.pacman.WallRectangle { x1:-1 y1:22 x2:2 y2:23 },
//
//      Model.pacman.WallRectangle { x1:24 y1:15 x2:Model.pacman.MazeData.GRID_SIZE + 1 y2:17 },
//      Model.pacman.WallRectangle { x1:24 y1:19 x2:25 y2:23 },
//      Model.pacman.WallRectangle { x1:24.5 y1:19 x2:27 y2:20 },
//      Model.pacman.WallBlackRectangle { x1:24 y1:19.05 x2:25 y2:20.2 },
//      Model.pacman.WallRectangle { x1:27 y1:22 x2:Model.pacman.MazeData.GRID_SIZE + 1 y2:23 },
//
//      Model.pacman.WallBlackRectangle { x1:-2 y1:8 x2:0 y2:Model.pacman.MazeData.GRID_SIZE },
//      Model.pacman.WallBlackRectangle {
//         x1:Model.pacman.MazeData.GRID_SIZE
//         y1:8
//         x2:Model.pacman.MazeData.GRID_SIZE + 2
//         y2:Model.pacman.MazeData.GRID_SIZE
//      },
//
//      Rectangle {
//        x: Model.pacman.MazeData.calcGridX(-0.5)
//        y: Model.pacman.MazeData.calcGridY(-0.5)
//        width: (Model.pacman.MazeData.GRID_SIZE + 1) * Model.pacman.MazeData.GRID_GAP
//        height: (Model.pacman.MazeData.GRID_SIZE + 1) * Model.pacman.MazeData.GRID_GAP
//        strokeWidth: Model.pacman.MazeData.GRID_STROKE
//        stroke: Color.BLUE
//        fill: null
//        arcWidth: 12
//        arcHeight: 12
...
//      },
//      Line {
//        startX: Model.pacman.MazeData.calcGridX(-0.5)
//        endX: Model.pacman.MazeData.calcGridX(-0.5)
//        startY: Model.pacman.MazeData.calcGridY(13)
//        endY: Model.pacman.MazeData.calcGridY(15)
//        stroke: Color.BLACK
//        strokeWidth: Model.pacman.MazeData.GRID_STROKE + 1
//        cache: true
//      },
//      Line {
//        startX: Model.pacman.MazeData.calcGridX(Model.pacman.MazeData.GRID_SIZE + 0.5)
//        endX: Model.pacman.MazeData.calcGridX(Model.pacman.MazeData.GRID_SIZE + 0.5)
//        startY: Model.pacman.MazeData.calcGridY(13)
//        endY: Model.pacman.MazeData.calcGridY(15)
//        stroke: Color.BLACK
//        strokeWidth: Model.pacman.MazeData.GRID_STROKE + 1
...
//      Line {
//        startX: Model.pacman.MazeData.calcGridX(-0.5)
//        endX: Model.pacman.MazeData.calcGridX(0)
//        startY: Model.pacman.MazeData.calcGridY(13)
//        endY: Model.pacman.MazeData.calcGridY(13)
//        stroke: Color.BLUE
//        strokeWidth: Model.pacman.MazeData.GRID_STROKE
//        cache: true
//      },
...
//        startX: Model.pacman.MazeData.calcGridX(-0.5)
//        endX: Model.pacman.MazeData.calcGridX(0)
//        startY: Model.pacman.MazeData.calcGridY(15)
//        endY: Model.pacman.MazeData.calcGridY(15)
//        stroke: Color.BLUE
//        strokeWidth: Model.pacman.MazeData.GRID_STROKE
//        cache: true
...
//      Line {
//        startX: Model.pacman.MazeData.calcGridX(Model.pacman.MazeData.GRID_SIZE + 0.5)
//        endX: Model.pacman.MazeData.calcGridX(Model.pacman.MazeData.GRID_SIZE)
//        startY: Model.pacman.MazeData.calcGridY(13)
//        endY: Model.pacman.MazeData.calcGridY(13)
//        stroke: Color.BLUE
//        strokeWidth: Model.pacman.MazeData.GRID_STROKE
...
//              size: 20
//              }
//        x: Model.pacman.MazeData.calcGridX(0),
//        y: Model.pacman.MazeData.calcGridY(Model.pacman.MazeData.GRID_SIZE + 2)
...
//        font: Font { size: 20
//                    }
//        x: Model.pacman.MazeData.calcGridX(22)
//        y: Model.pacman.MazeData.calcGridY(Model.pacman.MazeData.GRID_SIZE + 2)
...
//
//    insert Model.pacman.WallBlackRectangle{ x1:-3, y1:13, x2:0, y2:15} into group.content;
//    insert Model.pacman.WallBlackRectangle{ x1:29, y1:13, x2:31, y2:15} into group.content;
//
...
//    ImageView {
//      image: PACMAN_IMAGE
//      x: Model.pacman.MazeData.calcGridX(18)
//      y: Model.pacman.MazeData.calcGridY(30)
//      visible: bind livesCount > 0
//      cache: true
//    },
//    ImageView {
//      image: PACMAN_IMAGE
//      x: Model.pacman.MazeData.calcGridX(16)
//      y: Model.pacman.MazeData.calcGridY(30)
...
//    ImageView {
//      image: PACMAN_IMAGE
//      x: Model.pacman.MazeData.calcGridX(14)
//      y: Model.pacman.MazeData.calcGridY(30)
...
//    right side winner
    ...
    //middle cage Roi
//    group.getChildren().add(new Model.pacman.WallRectangle(10, 12, 15, 14));
    ...
    //cage and the gate
//    group.getChildren().add(new Model.pacman.WallRectangle(10, 12, 19, 17));
//    group.getChildren().add(new Model.pacman.WallRectangle(10.5f, 12.5f, 18.5f, 16.5f));
//    final Rectangle cageRect = new Rectangle(Model.pacman.MazeData.calcGridX(13),
//            Model.pacman.MazeData.calcGridY(12),
//            Model.pacman.MazeData.GRID_GAP * 3,
//            Model.pacman.MazeData.GRID_GAP / 2);
...
//    insert Model.pacman.WallBlackRectangle{ x1:29, y1:13, x2:31, y2:15} into group.content;
    ...
    //if (DEBUG) {
      //Model.pacman.MazeData.printData();
      //Model.pacman.MazeData.printDots();
    //}
...
//    	    if ( e.getCode() == KeyCode.VK_DOWN ) {
  ...
  public final View.Dot createDot(int x1, int y1, int type) {
//  public function createDot( x1: Number,  y1:Number, type:Integer ): View.Dot {
    View.Dot d = new View.Dot(MazeData.calcGridX(x1), MazeData.calcGridY(y1), type);

    if (type == MazeData.NORMAL_DOT) {
//      d = View.Dot {
//        x: Model.pacman.MazeData.calcGridX(x1)
//        y: Model.pacman.MazeData.calcGridY(y1)
//        dotType: type
//        visible: true
...
//    }
  ...
  // יצירה ש�? סוכריות
  public final View.courseDot createCandy(int x1, int y1, int type) {
//  public function createDot( x1: Number,  y1:Number, type:Integer ): View.Dot {
    View.courseDot d = null;
    if(type == MazeData.poison_Dot) {
      d = new View.courseDot(MazeData.calcGridX(x1), MazeData.calcGridY(y1), type, poison_dot_image);
      d.shouldStopAnimation.bind(gamePaused.or(waitForStart)); // patweb
      MazeData.setData(x1, y1, type);
      MazeData.setDot(x1, y1, d);
    }
    ...
    if(type == MazeData.silver_Dot){
      d = new View.courseDot(MazeData.calcGridX(x1), MazeData.calcGridY(y1), type, silver_dot_image);
      d.shouldStopAnimation.bind(gamePaused.or(waitForStart)); // patweb
      MazeData.setData(x1, y1, type);
      MazeData.setDot(x1, y1, d);
    }
    ...
    if(type == MazeData.question_Dot){
      d = new View.courseDot(MazeData.calcGridX(x1), MazeData.calcGridY(y1), type, question_dot_image);
      d.shouldStopAnimation.bind(gamePaused.or(waitForStart)); // patweb
      MazeData.setData(x1, y1, type);
      MazeData.setDot(x1, y1, d);
    }
...
//                    dotType = Model.pacman.MazeData.poison_Dot;
...
//                    System.out.println(x2);
  ...
  public void homeButton()
  {
   ...
   // pacMan.setPacmanColor(); // not needed code
    this.resumeGame();
  }
  //When Pacman eets Question Ghost
  public void pacManMeetsQuestionGhosts() {

    for (Ghost gq : questionGhosts) {
      if (hasMet(gq)) {
        if (gq.isHollow) {
          //sound when eats correct answer ghost
          Music.getInstance().musicPacmanMeetsQuestionGhost(1);
          View.ScoreText st = questionRight[getquestiondifficulty() - 1];
          ...
          //music when meets wrong question ghost
...
//Pacman answers the right question
...
//    for ( x in [1..Model.pacman.MazeData.GRID_SIZE] )
      for (int y = 1; y <= MazeData.GRID_SIZE_Y; y++) {
//      for ( y in [1..Model.pacman.MazeData.GRID_SIZE] ) {
        View.Dot dot = (View.Dot) MazeData.getDot(x, y);
...
//    int difficulty = 1;
  ...
  //Points for answering the question right
...
//Points for answering the question wrong
